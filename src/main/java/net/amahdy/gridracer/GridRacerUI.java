...
@Theme("gridracer")
@Widgetset("net.amahdy.gridracer.MyAppWidgetset")
@Push
public class GridRacerUI extends UI {
  ...
  protected void init(VaadinRequest request) {
    ...
    raceGround.getColumn("0").setWidth(55.0);
    raceGround.getColumn("1").setWidth(55.0);
    raceGround.getColumn("2").setWidth(55.0);
    raceGround.setWidth("167px");
    raceGround.setHeight("420px");
